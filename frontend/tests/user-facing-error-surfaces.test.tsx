...
const rawErrorSurfaces = [
  ...
  "../app/(protected)/(headered)/studio/tag-suggestions/page.tsx",
  "../app/(protected)/(headered)/feedback/[feedbackId]/page.tsx",
  "../app/(protected)/(headered)/feedback/mine/page.tsx",
  "../app/(protected)/(headered)/ip/[ipId]/discussions/new/page.tsx",
  ...
  "../app/(protected)/(headered)/settings/tag-groups/page.tsx",
