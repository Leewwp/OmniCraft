...
ALTER TABLE content_items
    ADD COLUMN IF NOT EXISTS rating_score DOUBLE PRECISION DEFAULT 0;
...
CREATE INDEX IF NOT EXISTS idx_content_items_rating_score
    ON content_items (rating_score DESC NULLS LAST);
