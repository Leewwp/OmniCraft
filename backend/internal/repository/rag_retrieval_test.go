...
func TestRAGRetrievalAppliesVisibilityAndCurrentGenerationPredicates(t *testing.T) {
	...
	for _, statement := range []string{
		...
		`INSERT INTO content_items (id, title, author_id, description, status, is_public) VALUES (10, 'Visible guide', 2, 'visible keyword', 'published', TRUE), (11, 'Private guide', 2, 'private keyword', 'published', FALSE), (12, 'Banned guide', 3, 'banned keyword', 'published', TRUE)`,
