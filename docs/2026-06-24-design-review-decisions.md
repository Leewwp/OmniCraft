...
| 编号 | 关联问题 | 标题 | 状态 | 讨论日期 |
|------|---------|------|------|---------|
| DEC-001 | B3 | 中文全文搜索查询侧配置对齐 | ✅ 已确认 | 2026-06-24 |
| DEC-002 | H1 | Token 存储方案降级为 P3 长期优化 | ✅ 已确认 | 2026-06-24 |
| DEC-003 | H3 | 法律文本暂时搁置,用户自行处理 | ⏸️ 搁置 | 2026-06-24 |
| DEC-004 | C1 | 信誉分配置补全,阈值统一为 10 | ✅ 已确认 | 2026-06-24 |
| DEC-005 | D1 | Studio 存根页面完整迁移(方案 B) | ✅ 已确认 | 2026-06-24 |
| DEC-006 | F1 | 瀑布流完整分页体验(方案 B) | ✅ 已确认 | 2026-06-24 |
| DEC-007 | G6 | 私信 SSE 实时推送(方案 A,Beta 前实现) | ✅ 已确认 | 2026-06-24 |
| DEC-008 | E1 | 草稿系统完整实现(方案 A,Beta 前实现) | ✅ 已确认 | 2026-06-24 |
| DEC-009 | E3 | 用户数据导出完整实现(方案 A,Beta 前实现) | ✅ 已确认 | 2026-06-24 |
| DEC-010 | E5 | 实现收藏集页面(方案 B) | ✅ 已确认 | 2026-06-24 |
| DEC-011 | A1 | 设计系统统一,homepage-v0.html 归档 | ✅ 已确认 | 2026-06-24 |
| DEC-012 | A3 | 更新 UI Design.md 移除二级筛选描述 | ✅ 已确认 | 2026-06-24 |
| DEC-013 | A4 | 归档 UI Design.md,同步相关文档 | ✅ 已确认 | 2026-06-24 |
| DEC-014 | B2 | 后端 DDD 完整重构 | ✅ 已确认 | 2026-06-24 |
| DEC-015 | E4 | 数据分析基础增强 | ✅ 已确认 | 2026-06-24 |
| DEC-016 | G1 | Tauri 离线功能暂缓(降级 P3) | ⏸️ 暂缓 | 2026-06-24 |
| DEC-017 | G2 | PWA 支持暂缓(降级 P3) | ⏸️ 暂缓 | 2026-06-24 |
| DEC-018 | H4 | 验证码和邮件配置切换为生产模式 | ✅ 已确认 | 2026-06-24 |
| DEC-019 | I4 | 启用队列系统 | ✅ 已确认 | 2026-06-24 |
| DEC-020 | C5 | Agent LLM 配置修复 | ✅ 已确认 | 2026-06-24 |
| — | B1/F2/F3/F4/G3/H2 | 已修复关闭(核查确认) | ✅ 已关闭 | 2026-06-24 |
| DEC-021 | A5 | 审查报告归档(先确认问题已解决) | ✅ 已确认 | 2026-06-24 |
| DEC-022 | A6 | task.json 保留作为历史记录 | ✅ 已确认 | 2026-06-24 |
| DEC-023 | D4 | 首页路由合并 | ✅ 已确认 | 2026-06-24 |
| DEC-024 | C6 | 下载权限复用互动阈值 | ✅ 已确认 | 2026-06-24 |
| DEC-025 | F5 | 移动端适配参考小红书 APP | ✅ 已确认 | 2026-06-24 |
| DEC-026 | G4 | Tauri 账号同步暂缓 | ⏸️ 暂缓 | 2026-06-24 |
| DEC-027 | I1 | 推荐冷启动增加兴趣选择(可跳过) | ✅ 已确认 | 2026-06-24 |
| DEC-028 | I2 | 向量索引升级为 HNSW | ✅ 已确认 | 2026-06-24 |
| DEC-029 | I3 | 热门排行配置项暴露 | ✅ 已确认 | 2026-06-24 |
| DEC-030 | J1 | 迁移验证范围更新 | ✅ 已确认 | 2026-06-24 |
| DEC-031 | J2 | 软删除策略部分统一 | ✅ 已确认 | 2026-06-24 |
| DEC-032 | E6/E7 | 桌面端部署和客户端下载现在实施 | ✅ 已确认 | 2026-06-24 |
| DEC-033 | G5 | 通知系统 SSE 实时推送 | ✅ 已确认 | 2026-06-24 |
...
## DEC-012:更新 UI Design.md 移除二级筛选描述
