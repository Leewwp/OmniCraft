...
| Async projection trace | Authenticated content update returned 200, but no outbox row was produced by the running instance; embedding and final projection remain unverified. | Jaeger evidence 2026-08-28; outbox/inbox tests | Local full-infra partial | No | Boundary only | Do not claim full projection trace |
