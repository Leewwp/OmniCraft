...
- 固定 goal 范围共 **69 个执行单元**（2026-09-02 修订一 +1）：T01–T55（55）+ U-01~U-05（5）+ A-01~A-07（7）+ #290（1）+ 语料 v2 #291（1）。其中 **18 个已完成并在 GitHub 以 `CLOSED/COMPLETED` 收口**：T01~T09（9）、T18~T20（3）、T22（1）、U-01~U-05（5）；剩余 51 个，#276/#282 仍为协调父票不计入。
